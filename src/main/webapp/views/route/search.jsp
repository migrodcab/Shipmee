							...
							<div class="row ruta">
								...
								<div class="row info-ruta">
									<div class="rfecha col-xs-7 col-sm-9">
										...
										<div class="view"><h4><a href="route/details/routeId=${route.id}"><spring:message code="route.details" />
										<i class="glyphicon glyphicon-chevron-right"></i></a></h4></div>
					...
					<div class="row text-center">
						...
						<security:authorize access="hasRole('USER')">
							<input type=submit class="btn-xs btn-llevar btn btn-danger contraoferta"
								value= "Contraoferta" onclick="location.href = 'routeOffer/user/create.do?routeId=${route.id}';"></input>
						</security:authorize>
